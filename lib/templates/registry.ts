...
const RAW: Omit<Template, 'hasPhoto'>[] = [
	...
	// Second city collection (right sidebar + more roles)
	{
		slug: 'lisbon',
		name: 'Lisbon',
		category: 'Creative',
		tags: ['Right sidebar', 'Photo', 'Playful'],
		blurb: 'A playful main-left / details-right layout for creatives.',
		layout: 'sidebarRight',
		accent: '#1e3a8a',
		headingFont: 'display',
	},
	{
		...
		name: 'Toronto',
		category: 'Professional',
		tags: ['Right sidebar', 'Clean', 'Approachable'],
		blurb: 'A clean layout with contact and skills in a right rail.',
		layout: 'sidebarRight',
		accent: '#0f766e',
		headingFont: 'display',
	},
	{
		...
		name: 'Vancouver',
		category: 'Creative',
		tags: ['Right sidebar', 'Warm', 'Modern'],
		blurb: 'A warm, modern layout with a supportive right column.',
		layout: 'sidebarRight',
		accent: '#b45309',
		headingFont: 'display',
	},
	{
		...
		name: 'Boston',
		category: 'Professional',
		tags: ['Classic', 'Impactful', 'Reliable'],
		blurb: 'An impactful single-column layout that reads with authority.',
		layout: 'classic',
		accent: '#1e293b',
		headingFont: 'display',
	},
	{
		...
		name: 'Stockholm',
		category: 'Technical',
		tags: ['Minimal', 'Analyst', 'Precise'],
		blurb: 'A precise, minimal layout for analysts and specialists.',
		layout: 'classic',
		accent: '#334155',
		headingFont: 'display',
	},
	{
		...
		name: 'Zurich',
		category: 'Executive',
		tags: ['Sidebar', 'Finance', 'Formal'],
		blurb: 'A formal sidebar layout for finance and senior roles.',
		layout: 'sidebarLeft',
		accent: '#1e3a8a',
		headingFont: 'display',
	},
	{
		...
		name: 'Elite',
		category: 'Executive',
		tags: ['Bold', 'Senior', 'Commanding'],
		blurb: 'A commanding sidebar layout for senior executives.',
		layout: 'sidebarLeft',
		accent: '#111c2d',
		headingFont: 'display',
	},
	{
		...
		name: 'Shanghai',
		category: 'Professional',
		tags: ['Sidebar', 'Detailed', 'Corporate'],
		blurb: 'A detailed corporate sidebar layout.',
		layout: 'sidebarLeft',
		accent: '#0369a1',
		headingFont: 'display',
	},
	{
		...
		name: 'Barcelona',
		category: 'Creative',
		tags: ['Two-column', 'Bold', 'Culinary'],
		blurb: 'A bold two-column layout with creative energy.',
		layout: 'twoColumn',
		accent: '#be123c',
		headingFont: 'display',
	},
	{
		...
		name: 'Berkeley',
		category: 'Student',
		tags: ['Header band', 'Modern', 'Entry level'],
		blurb: 'A modern header-band layout for entry-level candidates.',
		layout: 'headerBand',
		accent: '#2563eb',
		headingFont: 'display',
	},
	{
		...
		name: 'Singapore',
		category: 'Academic',
		tags: ['Header band', 'Teacher', 'Friendly'],
		blurb: 'A friendly header-band layout for educators.',
		layout: 'headerBand',
		accent: '#0e7490',
		headingFont: 'display',
	},
	{
		...
		name: 'Brussels',
		category: 'Academic',
		tags: ['Label-left', 'Teacher', 'Structured'],
		blurb: 'A structured label-left layout for teaching roles.',
		layout: 'labelLeft',
		accent: '#047857',
		headingFont: 'display',
	},
	{
		...
		name: 'Annie Grey',
		category: 'Executive',
		tags: ['Label-left', 'Director', 'Refined'],
		blurb: 'A refined editorial layout for directors and leaders.',
		layout: 'labelLeft',
		accent: '#3f3f46',
		headingFont: 'display',
	},
	{
		...
		name: 'Seoul',
		category: 'Professional',
		tags: ['Classic', 'Legal', 'Formal'],
		blurb: 'A formal single-column layout for legal and corporate roles.',
		layout: 'classic',
		accent: '#0f172a',
		headingFont: 'display',
	},
	{
		...
		name: 'Sydney',
		category: 'Professional',
		tags: ['Classic', 'Impactful', 'Versatile'],
		blurb: 'A versatile, impactful single-column layout.',
		layout: 'classic',
		accent: '#0d9488',
		headingFont: 'display',
	},
	{
		...
		name: 'Tokyo',
		category: 'Professional',
		tags: ['Label-left', 'Work history', 'Detailed'],
		blurb: 'A detailed label-left layout that foregrounds work history.',
		layout: 'labelLeft',
		accent: '#b91c1c',
		headingFont: 'display',
	},
	{
		...
		name: 'Ivy',
		category: 'Academic',
		tags: ['Academic', 'Traditional', 'CV'],
		blurb: 'A traditional academic CV layout.',
		layout: 'academic',
		accent: '#134e4a',
		headingFont: 'display',
	},
